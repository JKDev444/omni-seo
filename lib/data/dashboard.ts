...
export async function getDashboardData(): Promise<DashboardData> {
  ...
  const [openFindingsUnsorted, scorecard, citations] = await Promise.all([
    getOpenFindingsForSite(site.id),
  ...
  const openFindings = [...openFindingsUnsorted].sort((a, b) => priorityOrder[a.priority] - priorityOrder[b.priority]);
